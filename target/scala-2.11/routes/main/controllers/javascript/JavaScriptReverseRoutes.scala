...
package controllers.javascript {
  ...
  class ReverseSignupController(_prefix: => String) {
    ...
    // @LINE:15
    def showSignUpPage: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.SignupController.showSignUpPage",
      """
        function() {
    ...
    def createUser: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.SignupController.createUser",
      """
        function() {
  ...
  class ReverseAccountController(_prefix: => String) {
    ...
    // @LINE:17
    def showAccountsPage: JavaScriptReverseRoute = JavaScriptReverseRoute(
      "controllers.AccountController.showAccountsPage",
      """
        function() {
